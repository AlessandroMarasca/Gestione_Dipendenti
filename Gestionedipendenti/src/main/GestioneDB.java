...
public class GestioneDB
{
	...
	public static void createTabelle(Credenziali credenziali)
	{
		try (Connection conn = credenziali.connessione(); Statement stmt = conn.createStatement())
		{
			...
			String createTabellaManagers = "CREATE TABLE IF NOT EXISTS managers (" + "id_dipendente INT NOT NULL, "
					+ "bonus VARCHAR(45) NOT NULL, " + "team_gestito INT NOT NULL, " + "PRIMARY KEY (id_dipendente), "
	...
	public static void dropTabelle(Credenziali credenziali) {
